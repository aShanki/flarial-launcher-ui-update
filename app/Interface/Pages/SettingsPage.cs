...
sealed class SettingsPage : Grid
{
    ...
    readonly StackPanel _mainStack;
    ...
    internal SettingsPage(Configuration configuration)
    {
        ...
        Margin = new Thickness(FlarialTheme.SpacingLg);
        ...
        var header = new TextBlock
        {
            ...
            Margin = new Thickness(0, 0, 0, FlarialTheme.SpacingMd)
        };
        _mainStack.Children.Add(header);

        var buildCard = new FlarialCard { Margin = new Thickness(0, 0, 0, FlarialTheme.SpacingSm), EnableHover = false };
        ...
        _mainStack.Children.Add(buildCard);
        ...
        _mainStack.Children.Add(_customDllSection);
        ...
        perfStack.Children.Add(new Border
        {
            ...
            Margin = new Thickness(0, FlarialTheme.SpacingSm, 0, FlarialTheme.SpacingSm)
        });
        ...
        _mainStack.Children.Add(perfCard);
    ...
    private Border CreateRadioOption(string label, string description, int index, Configuration configuration)
    {
        ...
        var option = new Border
        {
            ...
            Padding = new Thickness(FlarialTheme.SpacingSm),
    ...
    {
        var buildCard = (FlarialCard)_mainStack.Children[1];
