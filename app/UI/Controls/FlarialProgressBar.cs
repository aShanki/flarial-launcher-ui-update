...
/// <summary>
/// A modern progress bar with gradient fill, glow effect, and smooth animations.
/// </summary>
class FlarialProgressBar : Grid
{
    ...
    /// <summary>
    /// Smoothly animates the progress to a new value.
    /// </summary>
    ...
    /// <summary>
    /// Completes the progress with a finishing animation.
    /// </summary>
